...
HX_LOCAL_STACK_FRAME(_hx_pos_7739d8dd15e92924_3_main,"Hello","main",0x20e85735,"Hello.main","Hello.hx",3,0x257b830c)
...
void Hello_obj::main(){
            	HX_STACKFRAME(&_hx_pos_7739d8dd15e92924_3_main)
HXDLIN(   3)		::Sys_obj::println(HX_("Hello, Haxe!",75,51,28,e6));
            	}
